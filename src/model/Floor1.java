...
public class Floor1 {
	...
	public void nextRoom(Room r, Door d) {
		if(rooms.indexOf(r) == 0 && d.getDirection() == 1) this.curentRoom = 1; //passe salle 1 à 2
		if(rooms.indexOf(r) == 0 && d.getDirection() == 0) this.curentRoom = 2; //passe salle 1 à 3
		if(rooms.indexOf(r) == 1 && d.getDirection() == 2) this.curentRoom = 0; //passe salle 2 à 1
		if(rooms.indexOf(r) == 2 && d.getDirection() == 3) this.curentRoom = 0; //passe salle 3 à 1
		if(rooms.indexOf(r) == 2 && d.getDirection() == 0) this.curentRoom = 3; //passe salle 3 à 4
		if(rooms.indexOf(r) == 2 && d.getDirection() == 2) this.curentRoom = 4; //passe salle 3 à 5
		if(rooms.indexOf(r) == 3 && d.getDirection() == 3) this.curentRoom = 2; //passe salle 4 à 3
		if(rooms.indexOf(r) == 4 && d.getDirection() == 1) this.curentRoom = 2; //passe salle 5 à 3
		if(rooms.indexOf(r) == 4 && d.getDirection() == 0) this.curentRoom = 5; //passe salle 5 à 6
		if(rooms.indexOf(r) == 5 && d.getDirection() == 3) this.curentRoom = 4; //passe salle 6 à 5
	}
